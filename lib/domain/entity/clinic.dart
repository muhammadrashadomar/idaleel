import '../../../used_later/models/address.dart';
import '../../../used_later/models/contacting_methods.dart';
import '../../../used_later/models/photo.dart';
import '../../../used_later/models/review.dart';
import '../../../used_later/models/service_price.dart';
import '../../../used_later/models/working_times.dart';
import '../../../used_later/models/main/service_provider.dart';

class Clinic extends ServiceProvider {
  double waitingTime;
  ...
  factory Clinic.fromMap(Map<String, dynamic> map) {
    return Clinic(
      waitingTime: map['waitingTime']?.toDouble() ?? 0.0,
      id: map['id'],
      title: map['title'] ?? '',
      profile: map['profile'] ?? '',
